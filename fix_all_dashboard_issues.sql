-- Script completo para correção de todos os problemas do dashboard
...
-- PARTE 2: Atualizar a função get_dashboard_data para ser resiliente a todas as diferenças
