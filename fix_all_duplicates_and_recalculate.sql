-- SCRIPT PARA REMOVER DUPLICATAS E RECALCULAR PROGRESSO PARA TODOS OS USUÁRIOS
-- Executa correção completa do sistema de check-ins

-- ========================================
-- PASSO 1: REMOVER CHECK-INS DUPLICADOS POR DATA
-- ========================================
...
-- ========================================
-- PASSO 2: RECALCULAR PROGRESSO PARA TODOS OS USUÁRIOS
-- ========================================
WITH correct_progress AS (
    SELECT 
        ...
        COUNT(DISTINCT DATE(cci.check_in_date)) * 10 as total_points, -- 10 pontos por dia único
...
-- ========================================
-- PASSO 3: RECALCULAR RANKINGS PARA TODOS OS DESAFIOS
-- ========================================
...
-- ========================================
-- PASSO 5: ESTATÍSTICAS GERAIS
-- ========================================
SELECT 
    'ESTATÍSTICAS GERAIS' as tipo,
    COUNT(DISTINCT cp.user_id) as total_usuarios,
    COUNT(DISTINCT cp.challenge_id) as total_desafios,
    SUM(cp.check_ins_count) as total_checkins_unicos,
    AVG(cp.points) as media_pontos
FROM challenge_progress cp;

-- ========================================
-- PASSO 6: VERIFICAR DUPLICATAS RESTANTES
-- ========================================
SELECT 
    'VERIFICAÇÃO DUPLICATAS' as tipo,
    p.name,
    cci.challenge_id,
