-- Script para corrigir o erro GROUP BY na função get_dashboard_data
-- Erro: column "g.created_at" must appear in the GROUP BY clause or be used in an aggregate function
