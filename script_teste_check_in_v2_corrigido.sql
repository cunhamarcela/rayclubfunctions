...
SELECT 
  ...
  (SELECT COUNT(*) FROM check_in_error_logs WHERE user_id = '906a27bc-ccff-4c74-ad83-37692782305a' AND challenge_id = 'c7e921a3-f66c-4c9d-b8d7-5ec7d69e3675') as total_errors,
