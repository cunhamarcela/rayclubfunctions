-- Script final para deploy da função get_dashboard_fitness corrigida
-- Correções:
-- 1. Semana atual (segunda a domingo) em vez de últimos 7 dias
-- 2. Tipos jsonb consistentes
-- 3. Melhor tratamento de nulls
...
SELECT 'Função get_dashboard_fitness corrigida e implantada com sucesso!' as status; 