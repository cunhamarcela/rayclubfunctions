...
-- Usando a estrutura exata da tabela workout_categories
...
-- Nota: A coluna se chama "workoutsCount" com C maiúsculo
...
-- 3. Limpar vídeos existentes (opcional - descomente se necessário)
...
-- Nota: Usando "workoutsCount" com aspas duplas para preservar o case
