-- ================================================================
-- FUNÇÕES SQL PARA INTEGRAÇÃO COM STRIPE WEBHOOK - VERSÃO CORRIGIDA
-- Data: 2025-01-19
-- Fix: Usar tabela 'profiles' ao invés de 'auth.users'
-- ================================================================
...
-- 2. FUNÇÃO PARA ATUALIZAR USUÁRIO POR EMAIL - VERSÃO CORRIGIDA
...
BEGIN
  ...
  -- CORREÇÃO: Buscar usuário na tabela profiles (não auth.users)
...
DECLARE
  ...
  result JSON;
BEGIN
  -- CORREÇÃO: Buscar dados do usuário usando profiles
  SELECT 
    upl.current_level,
...
-- CORREÇÃO APLICADA:
-- ✅ Mudou auth.users para profiles
-- ✅ Trigger agora usa tabela profiles
-- ✅ JOIN correto nas funções de verificação
