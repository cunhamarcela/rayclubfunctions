-- ================================================================
-- FUNÇÕES SQL PARA INTEGRAÇÃO COM STRIPE WEBHOOK - VERSÃO ULTIMATE
-- Data: 2025-01-19
-- Fix: DROP triggers PRIMEIRO, depois funções, para resolver dependências
-- ================================================================

-- PASSO 1: REMOVER TODOS OS TRIGGERS DEPENDENTES PRIMEIRO
...
-- PASSO 2: AGORA PODEMOS FAZER DROP DAS FUNÇÕES
...
-- PASSO 4: FUNÇÃO PRINCIPAL TOTALMENTE LIMPA
...
-- PASSO 5: FUNÇÃO PARA VERIFICAR STATUS DE PAGAMENTO
...
-- PASSO 6: FUNÇÃO PARA PROCESSAR USUÁRIOS PENDENTES
...
-- PASSO 7: FUNÇÃO TRIGGER PARA PROCESSAR USUÁRIOS PENDENTES
...
-- Teste rápido
SELECT 'Sistema Stripe pronto para uso!' as resultado_final; 