-- 🎯 TESTE COMPLETO DO SISTEMA DE RANKING E CHALLENGE_PROGRESS
-- 📋 Validação de TODOS os campos e funcionalidades
...
BEGIN
    ...
    -- Garantir que usuários existem
    INSERT INTO profiles (id, name, photo_url) VALUES 
    (test_user_1, 'Usuário Teste 1', 'https://example.com/photo1.jpg')
    ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, photo_url = EXCLUDED.photo_url;
    
    INSERT INTO profiles (id, name, photo_url) VALUES 
    (test_user_2, 'Usuário Teste 2', 'https://example.com/photo2.jpg')
    ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, photo_url = EXCLUDED.photo_url;
    
    INSERT INTO profiles (id, name, photo_url) VALUES 
    (test_user_3, 'Usuário Teste 3', 'https://example.com/photo3.jpg')
    ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, photo_url = EXCLUDED.photo_url;
...
DECLARE
    test_challenge_id UUID := 'c7e921a3-f66c-4c9d-b8d7-5ec7d69e3675';
    test_user_1 UUID := '906a27bc-ccff-4c74-ad83-37692782305a';
    workout_invalid_1 UUID;
    workout_invalid_2 UUID;
BEGIN
    ...
    )->'workout_id' INTO workout_invalid_1;
    ...
    )->'workout_id' INTO workout_invalid_2;
...
BEGIN
    ...
    RAISE NOTICE '   ✓ Foto: %', COALESCE(user1_progress.user_photo_url, 'NULL');
    ...
    RAISE NOTICE '   ✓ Foto: %', COALESCE(user2_progress.user_photo_url, 'NULL');
    ...
    RAISE NOTICE '   ✓ Foto: %', COALESCE(user3_progress.user_photo_url, 'NULL');
